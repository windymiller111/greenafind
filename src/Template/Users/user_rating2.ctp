          ...
          <?php 
           if(!$RatingList->isEmpty()){
            ...
            <tr>
               ...
               <td><?php echo $ratingval['Users']['username'];?></td>
              
              <td>
                 <?php if (!empty($ratingval['UserProfiles']['profile_image'])) {
                  echo $this->Html->image(base_url . '' . 'img/customer_uploads/'.$ratingval['UserProfiles']['profile_image'], array('width'=>'100px', 'height'=>'100px', 'alt' => 'green warrior',));
                }else{
                  echo $this->Html->image(base_url . '' . 'img/no-image.png', array('width'=>'100px', 'alt' => 'green warrior'));
                  }
                ?>
                </td>
                <td><?php echo $ratingval['rating'];?></td>
               <td><?php echo date('d-m-Y', strtotime($ratingval['created']));?></td>
